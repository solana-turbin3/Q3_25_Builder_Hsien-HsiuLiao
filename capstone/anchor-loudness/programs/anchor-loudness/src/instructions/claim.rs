...
- config: The configuration account for the  program
...
Functionality:
Points Calculation: Uses the accumulated points in the user's account 
...
Points accumulation: Points are earned when submitting concert experience
